...
export class BrickData {
    ...
    */
    set beat_pos(arg0) {
        wasm.__wbg_set_brickdata_beat_pos(this.__wbg_ptr, arg0);
    }
    /**
    * @returns {number}
    */
...
export class Game {
    ...
    */
    bricks_broken() {
        const ret = wasm.game_bricks_broken(this.__wbg_ptr);
        return ret;
    }
    /**
    * @returns {GameData}
    ...
    */
    input_command(input) {
        wasm.game_input_command(this.__wbg_ptr, input);
    }
    /**
    * @param {Input} input
    */
...
export class RenderingInstructions {
    ...
    */
    get num_graphics() {
        const ret = wasm.__wbg_get_renderinginstructions_num_graphics(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
    * @param {number} arg0
    ...
    */
    get graphics_ptr() {
        const ret = wasm.__wbg_get_renderinginstructions_graphics_ptr(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
    * @param {number} arg0
    */
    set graphics_ptr(arg0) {
        wasm.__wbg_set_renderinginstructions_graphics_ptr(this.__wbg_ptr, arg0);
    }
}
...
async function __wbg_init(input) {
    ...
    if (typeof input === 'undefined') {
        input = new URL('music_mercenary_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
